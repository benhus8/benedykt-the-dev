  ...
  return (
      <div className="relative bg-primary-darkest min-h-[350px] z-10 overflow-hidden">
        <div className="w-full flex flex-col justify-center items-center py-5 mt-5 mb-10" >
          ...
          <p className="text-white text-lg font-semiBold px-32 text-center break-words mt-2 mb-5">
            Want discuss something or get in touch? Feel free to contact me
          </p>
          <div className="flex flex-row items-center justify-between gap-4">
              <EmailIcon />
            <div className="flex items-center">
              <p className="text-primary-light font-bold text-2xl">{'benedykt.huszcza'}</p>
              <p className="text-primary-white font-bold text-lg pt-2">{'@gmail.com'}</p>
            </div>
          </div>
          <p className="text-primary-white font-semiBold text-lg mt-5">{'Or message me on social media'}</p>
            <button
                ...
                onClick={() => window.open("https://www.linkedin.com/in/benedykt-huszcza-478b69289/", "_blank")}
            >
                Contact!
            </button>
        </div>
  ...
  return (
      <div className="relative">
        <img
            src="/email_icon.svg"
            alt="Email"
            className="w-[45px] h-[45px] mt-2 cursor-pointer"
